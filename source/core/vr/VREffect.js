 ...
 * 
 * It is based on the lastest version available on threejs and is used automatically by the program.
 *
...
function VREffect(renderer, onError)
{
	...
	this.render = function(scene, camera, renderTarget, forceClear)
	{
		if(vrDisplay && self.isPresenting)
		{
			...
			//When rendering we don"t care what the recommended size is, only what the actual size of the backbuffer is.

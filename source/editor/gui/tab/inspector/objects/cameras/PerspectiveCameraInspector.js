...
function PerspectiveCameraInspector(parent, object)
{
	...
	this.filmGauge = new NumberBox(this.form);
	...
	this.filmOffset = new NumberBox(this.form);
	...
	this.focus = new NumberBox(this.form);
...
PerspectiveCameraInspector.prototype.updateInspector = function()
{
	...
	this.filmOffset.setValue(this.object.filmOffset);
	this.focus.setValue(this.object.focus);

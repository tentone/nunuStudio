...
tern.registerPlugin("threejs", function(server, options)
{
	...
	"BufferGeometryLoader": {
		...
		"prototype": {
			...
			"parse": {
				"!type": "fn(json: object) -> +BufferGeometry",
	...
	"ColladaLoader": {
		...
		"prototype": {
			...
			"setPreferredShading": {
				...
				"!doc": "Set the .[page:Integer shading] property on the resource's materials.<br>\n\t\tOptions are [page:Materials SmoothShading], [page:Materials FlatShading]."
			},
			"applySkin": {
				"!type": "fn(geometry: +Geometry, instanceCtrl: object, frame: number)",
	...
	"JSONLoader": {
		...
		"prototype": {
			...
			"loadAjaxJSON": {
				"!type": "fn(context: +JSONLoader, url: string, callback: function, texturePath: string, callbackProgress: function)",
	...
	"OBJMTLLoader": {
		...
		"prototype": {
			...
			"parse": {
				"!type": "fn(text: string, mtllibCallback: function) -> +Object3D",
	...
	"Material": {
		...
		"prototype": {
			...
			"side": {
				"!type": "Enum",
				"!doc": "Default is [page:Materials FrontSide]. Other options are [page:Materials BackSide] and [page:Materials DoubleSide]."
			},
			"needsUpdate": {
				"!type": "bool",
	...
	"MeshBasicMaterial": {
		...
		"prototype": {
			...
			"shading": {
				"!type": "string",
				"!doc": "Define shading type. Default is SmoothShading."
			},
			"wireframe": {
				"!type": "bool",
			...
			"refractionRatio": {
				"!type": "number",
				"!doc": "The index of refraction for an environment map using [page:Textures CubeRefractionMapping]. Default is *0.98*."
			}
		},
	...
	"MeshLambertMaterial": {
		...
		"prototype": {
			...
			"combine": {
				"!type": "number",
				"!doc": "Options are [page:Textures Multiply] (default), [page:Textures MixOperation], [page:Textures AddOperation]. If mix is chosen, the reflectivity is used to blend between the two colors."
			},
			"reflectivity": {
				"!type": "number",
				"!doc": "How much the environment map affects the surface; also see \"combine\"."
			...
			"shading": {
				"!type": "number",
				"!doc": "Options are [page:Materials SmoothShading] (default), [page:Materials FlatShading]."
			},
			"wireframe": {
				"!type": "bool",
	...
	"MeshPhongMaterial": {
		...
		"prototype": {
			...
			"combine": {
				"!type": "number",
				"!doc": "Options are [page:Textures MultiplyOperation] (default), [page:Textures MixOperation], [page:Textures AddOperation]. If mix is chosen, the reflectivity is used to blend between the two colors."
			},
			"reflectivity": {
				"!type": "number",
				"!doc": "How much the environment map affects the surface; also see \"combine\"."
	...
	"RawShaderMaterial": {
		...
		"prototype": {
			"!proto": "ShaderMaterial.prototype"
		},
	...
	"ShaderMaterial": {
		...
		"prototype": {
			...
			"shading": {
				"!type": "number",
				"!doc": "Define shading type, which determines whether normals are smoothed between vertices; possible values are [page:Materials SmoothShading] or [page:Materials FlatShading]. Default is SmoothShading."
			},
			"linewidth": {
				"!type": "number",
				"!doc": "Due to limitations in the <a href=\"https://code.google.com/p/angleproject/\" target=\"_blank\">ANGLE layer</a>, on Windows platforms linewidth will always be 1 regardless of the set value."
			...
			"vertexColors": {
				"!type": "number",
				"!doc": "Define how the vertices are colored, by defining how the *colors* attribute gets populated. Possible values are [page:Materials NoColors], [page:Materials FaceColors] and [page:Materials VertexColors]. Default is NoColors."
			},
			"skinning": {
				"!type": "bool",
	...
	"Color": {
		...
		"prototype": {
			...
			"setRGB": {
				"!type": "fn(r: number, g: number, b: number) -> +Color",
	...
	"Euler": {
		...
		"prototype": {
			...
			"setFromQuaternion": {
				"!type": "fn(q: +Quaternion, order: string) -> +Euler",
			...
			"setFromVector3": {
				"!type": "fn(vector: +Vector3, order: string) -> +Euler",
	...
	"Frustum": {
		...
		"prototype": {
			...
			"set": {
				"!type": "fn(p0: +Plane, p1: +Plane, p2: +Plane, p3: +Plane, p4: +Plane, p5: +Plane) -> bool",
	...
	"Line3": {
		...
		"prototype": {
			...
			"at": {
				"!type": "fn(t: number, optionalTarget: +Vector3) -> Vector",
			...
			"closestPointToPoint": {
				"!type": "fn(point: +Vector3, clampToLine: bool, optionalTarget: +Vector3) -> +Vector3",
			...
			"closestPointToPointParameter": {
				"!type": "fn(point: +Vector3, clampToLine: bool) -> number",
	...
	"Matrix3": {
		...
		"prototype": {
			...
			"set": {
				"!type": "fn(n11: number, n12: number, n13: number, n21: number, n22: number, n23: number, n31: number, n32: number, n33: number) -> +Matrix3",
			...
			"applyToBufferAttribute": {
				"!type": "fn(attribute: []) -> +BufferAttribute",
			...
			"getInverse": {
				"!type": "fn(matrix4: +Matrix4, throwOnInvertible: bool) -> +Matrix3",
	...
	"Matrix4": {
		...
		"prototype": {
			...
			"lookAt": {
				"!type": "fn(eye: +Vector3, center: +Vector3, up: +Vector3) -> +Matrix4",
			...
			"multiplyMatrices": {
				"!type": "fn(a: +Matrix4, b: +Matrix4) -> +Matrix4",
				"!doc": "Sets this matrix to *a x b*."
			},
			"multiplyScalar": {
				"!type": "fn(s: number) -> +Matrix4",
			...
			"decompose": {
				"!type": "fn(translation: +Vector3, quaternion: +Quaternion, scale: +Vector3) -> []",
			...
			"makePerspective": {
				"!type": "fn(left: number, right: number, top: number, bottom: number, near: number, far: number) -> +Matrix4",
	...
	"Plane": {
		...
		"prototype": {
			...
			"set": {
				"!type": "fn(normal: +Vector3, constant: number) -> +Plane",
			...
			"applyMatrix4": {
				"!type": "fn(matrix: +Matrix4, optionalNormalMatrix: +Matrix3) -> +Plane",
				"!doc": "Apply a Matrix4 to the plane. The second parameter is optional.\n\t\t\n\t\t<code>\n\t\tvar optionalNormalMatrix = new Matrix3().getNormalMatrix( matrix ) \n\t\t</code>"
			},
			"orthoPoint": {
				"!type": "fn(point: +Vector3, optionalTarget: +Vector3) -> +Vector3",
			...
			"setFromNormalAndCoplanarPoint": {
				"!type": "fn(normal: +Vector3, point: +Vector3) -> +Vector3",
			...
			"setFromCoplanarPoints": {
				"!type": "fn(a: +Vector3, b: +Vector3, c: +Vector3) -> +Plane",
	...
	"Quaternion": {
		...
		"prototype": {
			...
			"copy": {
				"!type": "fn(q: +Quaternion) -> +Quaternion",
			...
			"setFromAxisAngle": {
				"!type": "fn(axis: +Vector3, angle: number) -> +Quaternion",
			...
			"setFromUnitVectors": {
				"!type": "fn(vFrom: +Vector3, vTo: +Vector3) -> +Quaternion",
			...
			"multiply": {
				"!type": "fn(b: +Quaternion) -> +Quaternion",
			...
			"multiplyVector3": {
				"!type": "fn(vector: +Vector3, dest: +Vector3) -> +Quaternion",
	...
	"Sphere": {
		...
		"prototype": {
			...
			"setFromPoints": {
				"!type": "fn(points: [], optionalCenter: +Vector3) -> +Sphere",
	...
	"Triangle": {
		...
		"prototype": {
			...
			"setFromPointsAndIndices": {
				"!type": "fn(points: [], i0: number, i1: number, i2: number) -> +Triangle",
				"!doc": "Sets the triangle's vectors to the vectors in the array."
			},
			"set": {
				"!type": "fn(a: +Vector3, b: +Vector3, c: +Vector3) -> +Triangle",
			...
			"equals": {
				"!type": "fn(triangle: +Triangle) -> bool",
	...
	"Vector2": {
		...
		"prototype": {
			...
			"addVectors": {
				"!type": "fn(a: +Vector2, b: +Vector2) -> +Vector2",
			...
			"clampScalar": {
				"!type": "fn(min: number, max: number) -> +Vector2",
			...
			"lerpVectors": {
				"!type": "fn(v1: +Vector2, v2: +Vector2, alpha: number) -> +Vector2",
	...
	"Vector3": {
		...
		"prototype": {
			...
			"clampScalar": {
				"!type": "fn(min: number, max: number) -> +Vector3",
			...
			"lerp": {
				"!type": "fn(v: +Vector3, alpha: number) -> +Vector3",
			...
			"applyQuaternion": {
				"!type": "fn(quaternion: +Quaternion) -> +Vector3",
	...
	"Vector4": {
		...
		"prototype": {
			...
			"addVectors": {
				"!type": "fn(a: +Vector4, b: +Vector4) -> +Vector4",
				"!doc": "Sets this vector to *a + b*."
			},
			"sub": {
				"!type": "fn(v: +Vector4) -> +Vector4",
			...
			"lerpVectors": {
				"!type": "fn(v1: +Vector4, v2: +Vector4, alpha: number) -> +Vector4",
				"!doc": "Sets this vector to be the vector linearly interpolated between *v1* and *v2* with *alpha* factor."
			},
			"clone": {
				"!type": "fn() -> +Vector4",
			...
			"clamp": {
				"!type": "fn(min: +Vector4, max: +Vector4) -> +Vector4",
	...
	"WebGLRenderTarget": {
		...
		"prototype": {
			"wrapS": {
				"!type": "number",
				"!doc": "The default is ClampToEdgeWrapping, where the edge is clamped to the outer edge texels. The other two choices are RepeatWrapping and MirroredRepeatWrapping."
			},
			"wrapT": {
				"!type": "number",
				"!doc": "The default is ClampToEdgeWrapping, where the edge is clamped to the outer edge texels. The other two choices are RepeatWrapping and MirroredRepeatWrapping."
			...
			"magFilter": {
				"!type": "number",
				"!doc": "How the texture is sampled when a texel covers more than one pixel. The default is LinearFilter, which takes the four closest texels and bilinearly interpolates among them. The other option is NearestFilter, which uses the value of the closest texel."
			},
			"minFilter": {
				"!type": "number",
				"!doc": "How the texture is sampled when a texel covers less than one pixel. The default is LinearMipMapLinearFilter, which uses mipmapping and a trilinear filter. Other choices are NearestFilter, NearestMipMapNearestFilter, NearestMipMapLinearFilter, LinearFilter, and LinearMipMapNearestFilter. These vary whether the nearest texel or nearest four texels are retrieved on the nearest mipmap or nearest two mipmaps. Interpolation occurs among the samples retrieved."
			},
			"anisotropy": {
				"!type": "number",
			...
			"format": {
				"!type": "number",
				"!doc": "The default is RGBAFormat for the texture. Other formats are: AlphaFormat, RGBFormat, LuminanceFormat, and LuminanceAlphaFormat. There are also compressed texture formats, if the S3TC extension is supported: RGB_S3TC_DXT1_Format, RGBA_S3TC_DXT1_Format, RGBA_S3TC_DXT3_Format, and RGBA_S3TC_DXT5_Format."
			},
			"type": {
				"!type": "number",
				"!doc": "The default is UnsignedByteType. Other valid types (as WebGL allows) are ByteType, ShortType, UnsignedShortType, IntType, UnsignedIntType, HalfFloatType, FloatType, UnsignedShort4444Type, UnsignedShort5551Type, and UnsignedShort565Type."
			},
			"depthBuffer": {
				"!type": "boolean",
	...
	"WebGLRenderTargetCube": {
		...
		"prototype": {
			"!proto": "WebGLRenderTarget.prototype",
			"activeCubeFace": {
				"!type": "integer",
	...
	"WebGLRenderer": {
		...
		"prototype": {
			...
			"shadowMapType": {
				"!type": "number",
				"!doc": "Options are BasicShadowMap, PCFShadowMap, PCFSoftShadowMap. Default is PCFShadowMap."
			},
			"shadowMapCullFace": {
				"!type": "number",
				"!doc": "Default is CullFaceFront. The faces that needed to be culled. Possible values: CullFaceFront and CullFaceBack"
			},
			"shadowMapCascade": {
				"!type": "bool",
			...
			"getClearColor": {
				"!type": "fn() -> +Color",
				"!doc": "Returns a [page:Color Color] instance with the current clear color."
			},
			"getClearAlpha": {
				"!type": "fn() -> number",
			...
			"renderBufferDirect": {
				"!type": "fn(camera: +Camera, lights: [], fog: +Fog, material: +Material, geometryGroup: object, object: +Object3D)",
			...
			"render": {
				"!type": "fn(scene: +Scene, camera: +Camera, renderTarget: +WebGLRenderTarget, forceClear: bool)",
			...
			"setTexture": {
				"!type": "fn(texture: +Texture, slot: number)",
			...
			"clearTarget": {
				"!type": "fn(renderTarget: +WebGLRenderTarget, color: boolean, depth: boolean, stencil: boolean)",
	...
	"Texture": {
		...
		"prototype": {
			...
			"mapping": {
				"!type": "object",
				"!doc": "How the image is applied to the object. An object type of UVMapping is the default, where the U,V coordinates are used to apply the map, and a single texture is expected. The other types are CubeReflectionMapping, for cube maps used as a reflection map; CubeRefractionMapping, refraction mapping; and SphericalReflectionMapping, a spherical reflection map projection."
			},
			"wrapS": {
				"!type": "number",
				"!doc": "The default is ClampToEdgeWrapping, where the edge is clamped to the outer edge texels. The other two choices are RepeatWrapping and MirroredRepeatWrapping."
			...
			"type": {
				"!type": "number",
				"!doc": "The default is UnsignedByteType. Other valid types (as WebGL allows) are ByteType, ShortType, UnsignedShortType, IntType, UnsignedIntType, FloatType, UnsignedShort4444Type, UnsignedShort5551Type, and UnsignedShort565Type."
			},
			"anisotropy": {
				"!type": "number",
				"!doc": "The number of samples taken along the axis through the pixel that has the highest density of texels. By default, this value is 1. A higher value gives a less blurry result than a basic mipmap, at the cost of more texture samples being used. Use renderer.getMaxAnisotropy() to find the maximum valid anisotropy value for the GPU; this value is usually a power of 2."
